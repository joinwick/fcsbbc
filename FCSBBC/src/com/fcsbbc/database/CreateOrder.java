...
//	private boolean keyEnter = false, keyUpDown = false, contentEmpty = false;
//	private String finalItem;
//	private int buySellOperation = -1, openCloseOperation = -1;
//	private boolean mouseClick = false;
//	JcomboboxEntry jcomboboxEntry;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					CreateOrder createOrder = new CreateOrder(fundAvailable);
	 ...
	 * Create the frame.
	 */
	public CreateOrder(String fundAvailable) {
...
//		jcomboboxEntry = new JcomboboxEntry(instrumentIDArray);
//		JComboBox<Object> instrumentCombobox1 = jcomboboxEntry.jComboBox;
//		instrumentCombobox1.setBounds(250, 56, 120, 21);
//		contentPane.add(instrumentCombobox1);
...
//		JButton tradeSideBuyButton = new JButton("买");
...
//				String searchValue = (instrumentEntry != null && instrumentEntry.length() > 0) ? instrumentEntry.toLowerCase() : instrumentSelected;
//				SearchUtil.loopSearch(instrumentIDArray, searchValue)
...
//		JButton tradeSideSellButton = new JButton("卖");
...
//		JButton openFlagOpenButton = new JButton("开仓");
...
//		JButton openFlagCloseYButton = new JButton("平仓");
...
//		JButton openFlagCloseTButton = new JButton("平今");
		...
		quantityTextField.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent arg0) {
				...
				if (currentContext != null && currentContext.length() > 0) {
					if (maxLots > 0) {
//						int maxLength = String.valueOf(maxLots).length();
...
//		maxQuantityTextField = new JTextField("5");
